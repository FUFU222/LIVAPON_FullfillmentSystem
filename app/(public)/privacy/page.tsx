...
export const metadata: Metadata = {
  title: 'プライバシーポリシー | LIVAPON 配送管理システム'
};
...
const sections = [
  {
    heading: '1. 基本方針',
    body: [
      '株式会社CHAIRMAN（以下、「当社」といいます。）は、LIVAPON 配送管理システム（以下、「本サービス」といいます。）において取り扱う個人情報を保護するため、以下の方針に基づき安全かつ適切な管理を行います。'
    ]
  },
  {
    heading: '2. 取得する情報',
    body: [
      ...
      '・アカウント情報：氏名、会社名、役職、メールアドレス、電話番号、セラーコード等',
