...
4. Backfill tests for shipment creation/cancellation and dispatch selection logic before adding the realtime UX enhancements listed in `docs/61_dev_report_20251109.md`.
